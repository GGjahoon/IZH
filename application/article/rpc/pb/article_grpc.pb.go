...
func (c *articleClient) ArticleDelete(ctx context.Context, in *ArticleDeletRequest, opts ...grpc.CallOption) (*ArticleDeletResponse, error) {
	out := new(ArticleDeletResponse)
...
type ArticleServer interface {
	...
	ArticleDelete(context.Context, *ArticleDeletRequest) (*ArticleDeletResponse, error)
...
func (UnimplementedArticleServer) ArticleDelete(context.Context, *ArticleDeletRequest) (*ArticleDeletResponse, error) {
...
func _Article_ArticleDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServer).ArticleDelete(ctx, req.(*ArticleDeletRequest))
	}
	return interceptor(ctx, in, info, handler)
}
